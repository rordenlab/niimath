...
int show_help( void ) {
	...
	printf(" -bptfm  <hp_sigma> <lp_sigma> : Same as bptf but does not remove mean (emulates fslmaths < 5.0.7)\n");
	printf(" --compare <ref> : report if image matches, terminates without saving new image\n");
	printf("\n");
